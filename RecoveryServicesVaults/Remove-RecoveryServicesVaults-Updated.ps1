# Script to remove all Recovery Services vaults across all subscriptions
# Based on official Microsoft Azure script

function Remove-SingleVault {
    param (
...
function Remove-AllRecoveryServicesVaults {
...
# Example usage:
# Remove-AllRecoveryServicesVaults -WhatIf    # To see what would happen
